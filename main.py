...
def run_game():
    ...
    rows = get_integer_value("Enter the number of rows: ", 10, 1000)

    cols = get_integer_value("Enter the number of cols: ", 10, 1000)

    # Get the number of generations that the Game of Life should run for
    generations = get_integer_value("Enter how many generations do you want to see:", 1, 999999)
